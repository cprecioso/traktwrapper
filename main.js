...
(function(){
  var Q, createHash, resolve, underscoreKeypath, methods, request, sha1, strCast, Trakt, toString$ = {}.toString, split$ = ''.split;
  Q = require('q');
  createHash = require('crypto').createHash;
  resolve = require('url').resolve;
  underscoreKeypath = require('underscore-keypath');
