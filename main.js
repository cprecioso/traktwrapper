...
(function(){
  var Q, createHash, resolve, methods, request, sha1, strCast, Trakt, split$ = ''.split, toString$ = {}.toString;
  Q = require('q');
  ...
  module.exports = Trakt = (function(){
    ...
    var _username, _password, _apiKey, BASE_URL, prototype = Trakt.prototype, constructor = Trakt;
    ...
    prototype._construct = function(){
      ...
      for (i$ = 0, len$ = methods.length; i$ < len$; ++i$) {
        results$.push((fn$.call(this, methods[i$])));
      }
      return results$;
      function fn$(method){
        var x$, keyPath, name, accessed, i$, y$, len$, this$ = this;
        ...
        return accessed[name] = function(data){
          return this$.apiCall(method, data);
        };
      }
    };
    ...
    prototype.apiCall = function(arg$, data){
